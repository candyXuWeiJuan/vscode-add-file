...
const templateConfigPath = homedir + '\\.cm-cli\\template\\config.json';
const templateUserConfigPath = homedir + '\\.cm-cli\\template\\user.json';
const templateListPath =  homedir + '\\.cm-cli\\template\\list';
